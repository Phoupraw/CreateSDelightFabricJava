...
public final class CSDModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator generator) {
        ...
        for (Block block : new Block[]{CSDBlocks.CHOCOLATE_BLOCK, CSDBlocks.CREAM_BLOCK, CSDBlocks.APPLE_JAM_BLOCK}) {
        ...
        for (Item item : new Item[]{CSDItems.BUCKETED_EGG_LIQUID, CSDItems.BUCKETED_APPLE_JAM, CSDItems.EGG_SHELL, CSDItems.KELP_ASH}) {
