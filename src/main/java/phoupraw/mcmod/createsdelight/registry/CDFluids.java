...
import phoupraw.mcmod.createsdelight.init.CDModInitializer;
 ...
 * <li>若有装有该流体桶、瓶或其它物品，在{@link CDModInitializer#initializeAfterCreate()}用{@link VirtualFluids#emptyProviderOf}和{@link VirtualFluids#fullProviderOf}在{@link FluidStorage#combinedItemApiProvider}注册流体物品转运。<br/>
...
public final class CDFluids {
    ...
    static {
        ...
        register(CDIdentifiers.EGG_LIQUID, EGG_LIQUID);
