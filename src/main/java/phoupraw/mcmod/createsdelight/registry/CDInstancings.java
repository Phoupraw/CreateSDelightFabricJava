...
public final class CDInstancings {
    ...
    //public static final SimpleBlockEntityInstancingController<IronBarSkewerBlockEntity> IRON_BAR_SKEWER = InstancedRenderRegistry.configure(CDBETypes.IRON_BAR_SKEWER).factory(SingleRotatingInstance::new).apply();
