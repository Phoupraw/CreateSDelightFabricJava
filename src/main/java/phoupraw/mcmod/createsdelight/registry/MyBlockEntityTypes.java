...
/**
 方块实体及其方块编写流程：
 <ol>
 <li>在{@link phoupraw.mcmod.createsdelight.block.entity}创建方块实体类类（继承{@link com.simibubi.create.foundation.blockEntity.SmartBlockEntity}），创建符合{@link Factory}的构造器<br/>
 <li>在{@link phoupraw.mcmod.createsdelight.block}创建方块类，继承{@link Block}，实现{@link com.simibubi.create.foundation.block.IBE}<br/>
 <li>在{@link phoupraw.mcmod.createsdelight.block.entity.renderer}创建方块实体渲染器类（继承{@link com.simibubi.create.foundation.blockEntity.renderer.SmartBlockEntityRenderer}）
