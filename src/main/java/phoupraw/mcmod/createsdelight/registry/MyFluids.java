...
/**
 ...
 <li>在{@link MyModInitializer#initializeAfterCreate()}用{@link VirtualFluid#ATTRIBUTE_HANDLER}在{@link FluidVariantAttributes#register}注册属性。<br>
...
public final class MyFluids {
    ...
    public static final VirtualFluid PASTE = new VirtualFluid();
